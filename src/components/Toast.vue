...
const iconSvg = computed(() => {
  switch (props.type) {
    case 'success':
      return `<svg class="w-5 h-5 text-success-strong" fill="currentColor" viewBox="0 0 20 20">
    ...
    case 'error':
      return `<svg class="w-5 h-5 text-alert-strong" fill="currentColor" viewBox="0 0 20 20">
    ...
    case 'warning':
      return `<svg class="w-5 h-5 text-active-strong" fill="currentColor" viewBox="0 0 20 20">
    ...
    default:
      return `<svg class="w-5 h-5 text-accent-strong" fill="currentColor" viewBox="0 0 20 20">
