...
<template>
  ...
  <Modal v-model:modelValue="isSettingsOpen">
    ...
    <div class="bg-surface-hover dark:bg-surface-hover-dark rounded-t-xl px-6 py-4 text-left">
      <DialogTitle as="h2" id="modal-title" class="flex items-center gap-2 text-2xl font-semibold">
        <svg xmlns="http://www.w3.org/2000/svg" class="w-7 h-7 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
    ...
    <div class="bg-surface-1 dark:bg-surface-1-dark rounded-b-xl px-6 py-4 text-left">
      ...
      <!-- Bloque Apariencia -->
      <div class="mb-6">
        <p class="flex items-center gap-2 text-base font-semibold text-subtle dark:text-subtle-dark mb-2">
