...
<template>
  <main class="min-h-screen bg-app-bg text-text-main flex flex-col items-center pt-4 px-4"> <!-- pt aún más reducido -->
    <div class="flex items-center gap-x-3 py-2"> <!-- Padding vertical del contenedor del título reducido -->
    ...
    <!-- Contenedor nuevo para botones compactos -->
    <div class="w-full max-w-lg mt-4 mb-4 flex flex-col items-center gap-3"> <!-- Contenedor principal para las dos filas de botones, gap aumentado -->
    ...
    <!-- El antiguo contenedor de botones de gestión de datos ha sido eliminado -->
