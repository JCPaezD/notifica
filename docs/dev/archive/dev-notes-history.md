...
[03/04/2026]
Se añadió un sistema temporal de aviso de lanzamiento para comunicar la nueva etapa de Notifica y, cuando corresponde, facilitar la migración hacia la app Android publicada en Google Play.

**Comportamiento por plataforma:**
- Android nativa: no se muestra el aviso ni el botón `Novedades`.
- Android web / PWA y web no iOS: se muestra el aviso con CTA hacia Play Store.
- iOS web / PWA: se muestra el aviso sin CTA a app nativa y con copy específico para iPhone y iPad.

**Comportamiento funcional:**
- El banner puede cerrarse desde la `X` o desde el enlace contextual `Cerrar aviso`.
- El cierre queda persistido en `localStorage`.
- El aviso puede reabrirse desde un botón discreto `Novedades` en el menú lateral.
- El sistema está integrado en i18n (`ES`, `EN` y modo sistema) y no se muestra dentro de la app Android nativa.

**Alcance y carácter temporal:**
- Este sistema forma parte del lanzamiento y no debe considerarse una pieza permanente de la interfaz.
- Tras cerrar la fase de lanzamiento, debe revisarse si conviene retirarlo o simplificarlo.
